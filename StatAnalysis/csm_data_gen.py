...
file = open("0CSM_data_sheet.data" , "w")
...
for i in range(len(filelist)):
    ...
    if (len(filename_elements) > 2):
        ...
        ejectaMass = filename_elements[2]
        v_sn = filename_elements[3]
        massNi = filename_elements[4]
        massCSM = filename_elements[5]
        r_p = filename_elements[6]
        radiusCSM = filename_elements[7]
    ...
    # file.write(str(B) + " " + str(P) + " " + str(V) + " " + str(M) + " ") # TODO: I HAVE TO CHANGE THESE
    file.write(str(ejectaMass) + " " + str(v_sn) + " " + str(massNi) + " " + str(massCSM) + " " + str(r_p) + " " + str(radiusCSM) + " ")
